...
public class AccionesProyectos {
	...
	public Boolean grabarProyectos(ProyectosDTO entrada) {
		try {
			...
			PreparedStatement stmt = connection
					.prepareStatement("INSERT INTO proyectos VALUES(NULL,?,?,?,?,?,?,?,?,?,?,?,?,?)");
	...
	public ArrayList<ObjetoJComboBox> consultaProyectos(int empresa) {
		try {
			...
			String peticion = "SELECT id_proyecto, nombre FROM proyectos WHERE id_empresa = " + empresa
			...
			{
				do {
					ObjetoJComboBox temporal = new ObjetoJComboBox(result.getInt("id_proyecto"),
	...
	public ProyectosDTO buscaProyecto(ProyectosDTO proyecto) {
		...
		try {
			Connection connection = accService.getConexion();
			ResultSet result = null;
			String peticion = "SELECT * FROM proyectos WHERE id_cliente = '" + proyecto.getCliente()
					+ "' AND fecha_ini = '" + proyecto.getFechaIni() + "'";
			Statement stmt = connection.createStatement();
			result = stmt.executeQuery(peticion);
			// result.next();
			if (result.next()) {
	...
	public Boolean updateProyectos(ProyectosDTO proyecto) {
		try {
			...
			PreparedStatement stmt = connection.prepareStatement(
					"UPDATE proyectos set id_empresa = ?, fecha_ini = ?, fecha_fin = ?, fecha_cierre = ?, id_cliente=?, descripcion=?,"
	...
	public String buscaDescripcion(Integer proyecto, int empresa) {
		try {
			Connection connection = accService.getConexion();
			ResultSet result = null;
			String peticion = "SELECT descripcion FROM proyectos WHERE id_empresa = '" + empresa
	...
	public Integer buscaProyecto(String variable, int empresa) {
		try {
			Connection connection = accService.getConexion();
			ResultSet result = null;
			String peticion = "SELECT id_proyecto FROM proyectos WHERE id_empresa = '" + empresa
					+ "' AND nombre = '" + variable + "'";
			Statement stmt = connection.createStatement();
			result = stmt.executeQuery(peticion);
			if (result.next()) {
	...
	public ProyectosDTO buscaProyecto(int variable, int empresa) {
		...
		try {
			Connection connection = accService.getConexion();
			ResultSet result = null;
			String peticion = "SELECT * FROM proyectos WHERE id_proyecto = '" + variable + "' AND id_empresa = '"
					+ empresa + "'";
			Statement stmt = connection.createStatement();
			result = stmt.executeQuery(peticion);
			// result.next();
	...
	public ProyectosDTO infoProyecto(String variable, Integer idEmpresa) {
		...
		try {
			Connection connection = accService.getConexion();
			ResultSet result = null;
			String peticion = "SELECT * FROM proyectos WHERE nombre = '" + variable + "' AND id_empresa = '" + idEmpresa
					+ "'";
			Statement stmt = connection.createStatement();
			result = stmt.executeQuery(peticion);
			// result.next();
	...
	public ArrayList<ObjetoJComboBox> consultaProyectos(Integer idCliente, Integer idEmpresa) {
		try {
			...
			ResultSet result = null;
			ArrayList<ObjetoJComboBox> salida = new ArrayList<ObjetoJComboBox>();
			String peticion = "SELECT * FROM proyectos WHERE id_cliente = '" + idCliente + "' AND id_empresa = '" + idEmpresa + "' ORDER BY descripcion";
			Statement stmt = connection.createStatement();
			result = stmt.executeQuery(peticion);
			if (result.next())
				;
			...
			System.out.println("Error en consultaProyectos por idCliente: " + ex.getMessage().toString());
			return null;
		}
	}
	...
	public String buscaNombre(int proyecto, int empresa) {
		try {
			Connection connection = accService.getConexion();
			ResultSet result = null;
			String peticion = "SELECT nombre FROM proyectos WHERE id_empresa = '" + empresa
					+ "' AND id_proyecto = '" + proyecto + "'";
			Statement stmt = connection.createStatement();
			result = stmt.executeQuery(peticion);
			if (result.next()) {
			...
			System.out.println("Error buscaNombre proyecto: " + ex.getMessage().toString());
			return null;
		}
	}
